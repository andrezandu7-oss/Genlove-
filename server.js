...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; font-family: "Segoe UI", Arial, sans-serif; }
        ...
        .sidebar button, .sidebar .novo-btn, .sidebar .sair-btn {
            display:block;
            width:100%;
            padding:14px;
            margin:5px 0;
        ...
        .sidebar .novo-btn { background:#ffa500; color:#00331a; font-weight:bold; text-align:center; }
...
<body>
    ...
    <div class="main">
        ...
        <div id="dashboardSection" class="secao active">
            ...
            <div class="stats-grid" style="display:grid; grid-template-columns:repeat(4,1fr); gap:20px; margin-top:20px;">
                <div class="stat-card" style="background:white; padding:20px; border-radius:10px; text-align:center; box-shadow:0 2px 8px rgba(0,0,0,0.05);">
                    <h3>Laboratórios</h3>
                    <p id="statsLabs" style="font-size:2em; color:#006633;">0</p>
                </div>
                <div class="stat-card" style="background:white; padding:20px; border-radius:10px; text-align:center; box-shadow:0 2px 8px rgba(0,0,0,0.05);">
                    <h3>Hospitais</h3>
                    <p id="statsHospitais" style="font-size:2em; color:#006633;">0</p>
                </div>
                <div class="stat-card" style="background:white; padding:20px; border-radius:10px; text-align:center; box-shadow:0 2px 8px rgba(0,0,0,0.05);">
                    <h3>Empresas</h3>
                    <p id="statsEmpresas" style="font-size:2em; color:#006633;">0</p>
                </div>
                <div class="stat-card" style="background:white; padding:20px; border-radius:10px; text-align:center; box-shadow:0 2px 8px rgba(0,0,0,0.05);">
                    <h3>Total</h3>
                    <p id="statsTotal" style="font-size:2em; color:#006633;">0</p>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        // NOVA FUNÇÃO PARA CARREGAR CERTIFICADOS
